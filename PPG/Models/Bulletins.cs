    ...
    public class Bulletins
    {
        ...
        public DecryptedBulletin[] decryptBulletins (Bulletin[] bulletins)
        {
            ...
            for (int i = 0; i < bulletins.Length; i++)
            {
                ...
                DecryptedBulletin decryptedBulletin = JsonConvert.DeserializeObject<DecryptedBulletin>(str);
                decryptedBulletins[i] = decryptedBulletin;
            }
            return decryptedBulletins;
        }

        private System.Numerics.BigInteger RandomIntegerBelow(System.Numerics.BigInteger N)
        {
